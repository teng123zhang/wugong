...
import com.guli.order.exception.OrderException;
import com.guli.order.mapper.EduPayMapper;
 ...
 */
@Service
public class EduPayServiceImpl extends ServiceImpl<EduPayMapper, EduPay> implements EduPayService {
@Autowired
